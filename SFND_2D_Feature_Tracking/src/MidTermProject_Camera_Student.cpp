...
int main(int argc, const char *argv[])
{
    ...
    // std::ofstream myfile;
    // myfile.open("detector_descriptor_perf.csv");
    // myfile << "Detector,Descriptor,Frame,Total Keypoints,Keypoints in ROI,Keypts in ROI matched,Time for detection [ms],Time for descriptor [ms],Total time [ms],\n";
    // myfile << "a,b,c,\n";
    // myfile.close();
